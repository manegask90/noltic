<?php $connect = json_decode(json_encode(SQ_Classes_Helpers_Tools::getOption('connect'))); ?>
<div class="ga-connect-place">
    ...
    <?php } else { ?>
        <div class="col-sm-12 bg-googlesc py-2 mb-2">
            <div class="col-sm-12">
                <h4 class="text-white py-3"><?php echo __('Connect this site to Google Search Console', _SQ_PLUGIN_NAME_); ?></h4>
