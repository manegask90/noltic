        ...
        <div class="d-flex flex-row flex-nowrap flex-grow-1 bg-white pl-3 pr-0 mr-0">
            <div class="flex-grow-1 mr-3 sq_flex">
                ...
                <div class="card col-sm-12 p-0">
                    ...
                    <div id="sq_settings">
                        ...
                        <div class="col-sm-12 p-0 py-3">
                            ...
                            <?php } else { ?>
                                <div class="sq_step sq_step1 my-2">
                                    <h4 class="text-success text-center my-4"><?php echo __('Step 1/4: Enter a starting 2-3 words keyword', _SQ_PLUGIN_NAME_) ?></h4>
                            ...
                            <div class="sq_step sq_step2 my-2" style="display: none">
                                <h4 class="text-success text-center my-4"><?php echo __('Step 2/4: Choose a country for your keyword research', _SQ_PLUGIN_NAME_) ?></h4>
                            ...
                            <div class="sq_step sq_step3  my-2" style="display: none; min-height: 250px">
                                <h4 class="text-success text-center my-4"><?php echo __('Step 3/4: Select similar keywords from below', _SQ_PLUGIN_NAME_) ?>
                                    <div class="text-center small my-2"><?php echo __('Each selected keyword will consume 1 credit from your keyword research credits.', _SQ_PLUGIN_NAME_) ?></div>
                                </h4>
                                <div class="col-sm-10 offset-1">
                                    ...
                                    <h4 class="sq_research_error text-warning text-center" style="display: none"><?php echo sprintf(__('We could not find similar keywords. %sClick on "Do research"', _SQ_PLUGIN_NAME_), '<br />') ?></h4>
                                </div>
                                <div class="row col-sm-12 mt-5">
                                    ...
                                    <?php if ($view->checkin->subscription_research == 'deep') { ?>
                                        <div class="col-sm-8 mx-0 my-3 p-0">
                                            <div class="row col-sm-12 m-0 p-0">
                                                <div class="col-sm-6 m-0 p-0 text-center">
                                                    <button type="button" class="btn btn-success px-5" onclick="jQuery('.sq_step4').sq_getResearch(50);"><?php echo __('Do a deep research', _SQ_PLUGIN_NAME_) ?></button>
                                                    <div class="small text-black-50">(may take 2-3 minutes)</div>
                                                </div>
                                                <div class="col-sm-6 m-0 p-0 text-right">
                                                    <button type="button" class="sqd-submit btn btn-success px-5" onclick="jQuery('.sq_step4').sq_getResearch(10);"><?php echo __('Do research', _SQ_PLUGIN_NAME_) ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } else { ?>
                            ...
                            <div class="sq_step sq_step4 col-sm-12 my-2 px-0" style="display: none; min-height: 130px !important;">
                                ...
                                <h4 class="sq_research_success text-success text-center my-2" style="display: none"><?php echo __('Step 4/4: We found some relevant keywords for you', _SQ_PLUGIN_NAME_) ?></h4>
                                ...
                                <h4 class="sq_research_error text-warning text-center" style="display: none"><?php echo __('Step 4/4: We could not find relevant keywords for you', _SQ_PLUGIN_NAME_) ?></h4>
                ...
                <div class="col-sm-12 text-center m-3">
                    <a href="https://howto.squirrly.co/wordpress-seo/journey-to-better-ranking-day-2/" target="_blank"><?php echo __('How to Find Amazing Keywords and get more search traffic?', _SQ_PLUGIN_NAME_) ?></a>
                </div>
            </div>
