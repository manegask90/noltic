                ...
                <div class="card col-sm-12 p-0">
                    ...
                    <div class="card-body">
                        <div class="col-sm-12 my-2 text-black-50">
                            <em><?php echo sprintf(__('%sNote:%s remember that it takes anywhere between %s1 minute to 5 minutes%s to generate the new audit for each page. There is a lot of processing involved.'), '<strong>', '</strong>', '<strong>', '</strong>'); ?></em>
                        </div>
                    </div>
