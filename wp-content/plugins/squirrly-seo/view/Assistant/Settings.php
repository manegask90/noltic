                    ...
                    <div class="card col-sm-12 p-0">
                        <div class="card-body p-0 m-0 bg-title rounded-top  row">
                            <div class="card-body p-2 bg-title rounded-top">
                                ...
                                <h3 class="card-title py-4"><?php _e('Live Assistant Settings', _SQ_PLUGIN_NAME_); ?>:</h3>
                                                    ...
                                                    <div class="col-sm-12 p-0">
                                                        <div class="col-sm-12 row py-2 mx-0 my-3">
                                                            <div class="col-sm-4 p-1 pr-3">
                                                                <div class="font-weight-bold"><?php _e('Live Assistant Type', _SQ_PLUGIN_NAME_); ?>:</div>
                                                                <div class="small text-black-50"><?php echo __('Select how you want Squirrly Live Assistant to load in editor.', _SQ_PLUGIN_NAME_); ?></div>
                                                            </div>
                                                            <div class="col-sm-8 p-0 input-group">
                                                                <select name="sq_sla_type" class="form-control bg-input mb-1">
                                                                    <option value="auto" <?php echo((SQ_Classes_Helpers_Tools::getOption('sq_sla_type') == 'auto') ? 'selected="selected"' : '') ?>><?php _e('Auto', _SQ_PLUGIN_NAME_); ?></option>
                                                                    <option value="integrated" <?php echo((SQ_Classes_Helpers_Tools::getOption('sq_sla_type') == 'integrated') ? 'selected="selected"' : '') ?>><?php _e('Integrated Box', _SQ_PLUGIN_NAME_); ?></option>
                                                                    <option value="floating" <?php echo((SQ_Classes_Helpers_Tools::getOption('sq_sla_type') == 'floating') ? 'selected="selected"' : '') ?>><?php _e('Floating Box', _SQ_PLUGIN_NAME_); ?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 row mb-1 ml-1">
                                                <div class="checker col-sm-12 row my-2 py-1">
                                                    <div class="col-sm-12 p-0 sq-switch sq-switch-sm">
                                                        ...
                                                        <label for="sq_sla_frontend" class="ml-2"><?php _e('Activate Live Assistant in Frontend', _SQ_PLUGIN_NAME_); ?><span class="text-danger"> <?php _e('(BETA)', _SQ_PLUGIN_NAME_); ?></span><a href="https://howto.squirrly.co/kb/squirrly-live-assistant/#Add-Live-Assistant-in-Frontend" target="_blank"><i class="fa fa-question-circle m-0 px-2" style="display: inline;"></i></a></label>
                                                        <div class="offset-1 small text-black-50"><?php _e('Load Squirrly Live Assistant in Frontend to customize the posts and pages with Builders.', _SQ_PLUGIN_NAME_); ?></div>
                                                        <div class="offset-1 small text-warning"><?php _e('Currently supports the Elementor Builder plugin.', _SQ_PLUGIN_NAME_); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
