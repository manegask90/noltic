        ...
        <div class="sq_tasks">
            <ul>
                ...
                foreach ($sla_tasks as $category => $row) { ?>
                    <li class="sq_tasks_category" style="display: none"><?php echo $category ?></li>
                    <?php foreach ($row as $name => $task) { ?>
                        <li id="<?php echo 'sq_' . $name . '' ?>" style="display: none"><?php echo $task['title'] ?>
                            <div class="arrow"><p class="sq_help"><?php echo $task['help'] ?></p></div>
                        </li>
                    <?php }
                } ?>
