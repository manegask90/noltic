                                            ...
                                            <div class="col-sm-12 row mb-1 ml-1">
                                                <div class="checker col-sm-12 row my-2 py-1">
                                                    <div class="col-sm-12 p-0 sq-switch sq-switch-sm">
                                                        ...
                                                        <div class="offset-1 small text-black-50"><?php echo sprintf(__('You can always update an URL on Facebook if you change its Social Media Image. Visit %sOpen Graph Debugger%s', _SQ_PLUGIN_NAME_), '<a href="https://developers.facebook.com/tools/debug/?q=' . home_url() . '" target="_blank" ><strong>', '</strong></a>'); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
