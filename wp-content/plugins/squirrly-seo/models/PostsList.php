...
class SQ_Models_PostsList {
    ...
    public function getPostButton($post_id = 0, $post_type = 'post') {
        ...
        $button .= '<a class="sq_column_button" href="' . SQ_Classes_Helpers_Tools::getAdminUrl('sq_bulkseo', 'bulkseo', array('sid=' . $post_id, 'stype=' . $post_type)) . '"  target="_blank">' . __('Edit Snippet', _SQ_PLUGIN_NAME_) . '</a>';
    ...
    public function getTaxButton($term_id = 0, $taxonomy = 'post') {
        ...
        $button .= '<a class="sq_column_button" href="' . SQ_Classes_Helpers_Tools::getAdminUrl('sq_bulkseo', 'bulkseo', array('sid=' . $term_id, 'stype=' . $taxonomy)) . '"  target="_blank">' . __('Edit Snippet', _SQ_PLUGIN_NAME_) . '</a>';
