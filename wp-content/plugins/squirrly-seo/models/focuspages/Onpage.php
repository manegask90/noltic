...
class SQ_Models_Focuspages_Onpage extends SQ_Models_Abstract_Assistant {
    ...
    public function getHeader() {
        ...
        $header .= '<li class="completed">
                    <a href="' . SQ_Classes_Helpers_Tools::getAdminUrl('sq_seosettings') . '" target="_blank" class="btn btn-success text-white col-sm-8 offset-2 mt-3">' . __('Go to SEO Settings', _SQ_PLUGIN_NAME_) . '</a>
                </li>';
